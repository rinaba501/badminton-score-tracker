...
| 5 — Cross-person sharing | design in [#93](https://github.com/rinaba501/badminton-score-tracker/issues/93); enables [#13](https://github.com/rinaba501/badminton-score-tracker/issues/13) | In progress — 5a (orientation-neutral MatchRecord) and 5b (Club/clubId data model) done; 5c–5f (CKShare mechanics, management UI, invite/accept, multi-club polish) not yet started |
