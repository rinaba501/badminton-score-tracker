...
| 7 — Friend graph (v1, graph-only) | not yet issue-tracked | 7a (`FriendProfile`/`FriendRequest` data model), 7b (public-DB plumbing) done — 7c (AppStore integration), 7d (invite link), 7e (Friends UI) planned |
