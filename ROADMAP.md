...
| 7 — Friend graph (v1, graph-only) | not yet issue-tracked | 7a-7e done (data model, public-DB plumbing, AppStore integration, invite link + deep-link consumption, Friends UI) — 7f (push subscription + code-entry fallback) optional/non-blocking |
