...
//
//  StoreKit 2 plumbing for the monetization model (see BadmintonCore's
//  Entitlements.swift for the pure product-ID → feature mapping this feeds).
...
//
//  Purchases work natively on watchOS via StoreKit 2; the Watch paywall is a
//  slim list, the iPhone one is the full storefront.
//
