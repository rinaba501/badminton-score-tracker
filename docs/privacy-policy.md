...
If you are signed into iCloud, match history, player roster, and settings are synced via iCloud key-value store. This sync is handled entirely by Apple. You can disable iCloud for this app in **Settings → [your name] → iCloud** on your iPhone.
