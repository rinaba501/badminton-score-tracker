...
| # | Feature | PR |
|---|---|---|
| 222 | iOS home screen: stat strip cells (Matches/Win rate/Players) now navigate to History/Stats/Players; a "last match" card (reusing MatchHistoryRow) fills the dead space below the menu when history isn't empty | #TBD |
